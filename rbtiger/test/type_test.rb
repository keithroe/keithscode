...
class TestSymbol < Test::Unit::TestCase
  ...
  def test_types
    ...
    array_type1  = RBTiger::ArrayType.new( RBTiger::IntType.new )
    array_type2  = RBTiger::ArrayType.new( RBTiger::IntType.new )
    array_type3  = array_type1 
    record_type1 = RBTiger::RecordType.new( [ [RBTiger::Symbol::create( "author" ), RBTiger::StringType.new ] ,
                                              [RBTiger::Symbol::create( "isbn" ),   RBTiger::IntType.new] ] )
    record_type2 = RBTiger::RecordType.new( [ [RBTiger::Symbol::create( "author" ), RBTiger::StringType.new ] ,
                                              [RBTiger::Symbol::create( "isbn" ),   RBTiger::IntType.new] ] )
    record_type3 = RBTiger::RecordType.new( [ [RBTiger::Symbol::create( "foo" ), RBTiger::StringType.new ] ] )
